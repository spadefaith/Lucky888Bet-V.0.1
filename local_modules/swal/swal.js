!function (t, e) {
  ...
  function dt(t) {
    ...
    wt(n) && (e && (n.style.transition = 'none', n.style.width = '100%'), setTimeout(function () {
      n.style.transition = 'width '.concat(t / 1000, 's linear'),
      n.style.width = '0%'
    }, 10))
  }
  function pt() {
  ...
  function ht(t, e) {
    ...
    o = u,
    i = l,
    (r = e).buttonsStyling ? (vt([n,
    o,
    i], $.styled), r.confirmButtonColor && (n.style.backgroundColor = r.confirmButtonColor), r.denyButtonColor && (o.style.backgroundColor = r.denyButtonColor), r.cancelButtonColor && (i.style.backgroundColor = r.cancelButtonColor)) : bt([n,
    o,
    i], $.styled),
  ...
  kt = function (t) {
    ...
    i,
    r,
    a = !!(i = k()) && (i.parentNode.removeChild(i), bt([document.documentElement,
    document.body], [
      $['no-backdrop'],
      $['toast-shown'],
      $['has-column']
  ...
  Dt = function (t, e) {
    ...
    if (n) for (var o in !function (t) {
      for (var e = 0; e < t.attributes.length; e++) {
        ...
        - 1 === ['type',
        'value',
        'style'].indexOf(n) && t.removeAttribute(n)
      }
  ...
  Mt.select = function (t, e) {
    ...
    e.inputPlaceholder && (n = document.createElement('option'), _(n, e.inputPlaceholder), n.value = '', n.disabled = !0, n.selected = !0, t.appendChild(n)),
    St(t, t, e),
    t
  },
  Mt.radio = function (t) {
  ...
  Yt = function (t, e) {
    if (e.iconColor) {
      ...
      ]; n < o.length; n++) ct(t, o[n], 'backgroundColor', e.iconColor);
  ...
  Jt = function (t, e) {
    ...
    e.toast ? (vt([document.documentElement,
    document.body], $['toast-shown']), vt(t, $.toast)) : vt(t, $.modal),
    z(t, e, 'popup'),
  ...
  function ce(t) {
    for (var e in t) re(o = e) || W('Unknown parameter "'.concat(o, '"')),
        ...
        return c(i, [
          {
            key: '_main',
            value: function (t, e) {
              return f(u(i.prototype), '_main', this).call(this, t, s({
              }, e, r))
            }
          }
        ]),
  ...
  function fe() {
    var t,
    e;
    Tt.innerParams.get(this) && (t = Tt.domCache.get(this), at(t.loader), (e = t.popup.getElementsByClassName(t.loader.getAttribute('data-button-to-replace'))).length ? rt(e[0], 'inline-block') : wt(L()) || wt(q()) || wt(j()) || at(t.actions), bt([t.popup,
    t.actions], $.loading), t.popup.removeAttribute('aria-busy'), t.popup.removeAttribute('data-loading'), t.confirmButton.disabled = !1, t.denyButton.disabled = !1, t.cancelButton.disabled = !1)
  }
  function me() {
  ...
  function Ie(t) {
    ...
    U() && (Je(e, t.scrollbarPadding, o), g(document.body.children).forEach(function (t) {
      t === k() || function (t, e) {
  ...
  _e = function (t) {
    ...
    return t && (Ye(t, [
      ...
      'height',
      'alt'
    ]), t.hasAttribute('src') && (e.imageUrl = t.getAttribute('src')), t.hasAttribute('width') && (e.imageWidth = t.getAttribute('width')), t.hasAttribute('height') && (e.imageHeight = t.getAttribute('height')), t.hasAttribute('alt') && (e.imageAlt = t.getAttribute('alt'))),
    e
  },
  Fe = function (t) {
    var e = {
    ...
    return t && (Ye(t, [
      'type',
      'color'
    ]), t.hasAttribute('type') && (e.icon = t.getAttribute('type')), t.hasAttribute('color') && (e.iconColor = t.getAttribute('color')), e.iconHtml = t.innerHTML),
    e
  },
  ze = function (t) {
    var n = {
    ...
    e && (Ye(e, [
      ...
      'placeholder',
      'value'
    ]), n.input = e.getAttribute('type') || 'text', e.hasAttribute('label') && (n.inputLabel = e.getAttribute('label')), e.hasAttribute('placeholder') && (n.inputPlaceholder = e.getAttribute('placeholder')), e.hasAttribute('value') && (n.inputValue = e.getAttribute('value')));
  ...
  Ye = function (e, n) {
    g(e.attributes).forEach(function (t) {
      - 1 === n.indexOf(t.name) && W(['Unrecognized attribute "'.concat(t.name, '" on <').concat(e.tagName.toLowerCase(), '>.'),
  ...
  $e = function (t, e, n) {
    ...
    document.body], $.shown),
    n.heightAuto && n.backdrop && !n.toast && vt([document.documentElement,
  ...
  hn = function (t, e, n) {
    ...
    'file'].indexOf(n.input) && (_t(), e.preventDefault())
  },
  gn = function (t, e) {
  ...
  vn = function (t) {
    - 1 !== [L(),
    q(),
    j()].indexOf(document.activeElement) && (t = - 1 !== dn.indexOf(t) ? 'nextElementSibling' : 'previousElementSibling', (t = document.activeElement[t]) && t.focus())
  },
  bn = function (t, e, n) {
  ...
  function xn(t, e) {
    ...
    o = s({
    }, se.showClass, e.showClass, n.showClass, t.showClass),
    i = s({
    }, se.hideClass, e.hideClass, n.hideClass, t.hideClass);
    return (n = s({
    }, se, e, n, t)).showClass = o,
    n.hideClass = i,
  ...
  function Bn(a, c, s) {
    return new Promise(function (t) {
      ...
      r = a,
      'select' === (t = s).input || 'radio' === t.input ? en(r, t) : - 1 !== ['text',
      'email',
      'number',
      'tel',
      'textarea'].indexOf(t.input) && (b(t.inputValue) || w(t.inputValue)) && nn(r, t),
      Ie(s),
      En(ee, s, e),
      On(c, s),
      setTimeout(function () {
